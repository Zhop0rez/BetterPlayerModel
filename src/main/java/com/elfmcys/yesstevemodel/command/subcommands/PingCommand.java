...
public class PingCommand {
    ...
    private static int executePing(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        playerOrException.sendSystemMessage(Component.translatable("message.better_player_model.client.ping_result", Platform.getMod(YesSteveModel.MOD_ID).getVersion()));
