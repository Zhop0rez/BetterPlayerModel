...
public class ModelInfoCapability {
    ...
    public void deserializeNBT(CompoundTag compoundTag) throws NumberFormatException {
        this.modelId = compoundTag.contains("model_id", 8) ? compoundTag.getString("model_id") : "";
        this.selectTexture = compoundTag.contains("select_texture", 8) ? compoundTag.getString("select_texture") : "";
        ...
        if (compoundTag.contains("molang_storage", 10)) {
