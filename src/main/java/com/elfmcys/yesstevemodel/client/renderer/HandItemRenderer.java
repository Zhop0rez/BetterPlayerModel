...
public class HandItemRenderer {
    ...
    public void renderHandItem(LocalPlayer localPlayer, ModelAssembly modelAssembly, PlayerCapability capability, HumanoidArm arm, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, float partialTick) {
        ...
        ResourceLocation Identifier = event.getTextureLocation() == null ? capability.getTextureLocation() : event.getTextureLocation();
        ...
        NativeModelRenderer.renderMesh(vertexConsumer, poseStack.last(), model.getGeoModel(), matrixData, absPivotData, textureIndex, renderPartMask, packedLight, OverlayTexture.NO_OVERLAY, 1.0f, 1.0f, 1.0f, 1.0f, Identifier, false);
        poseStack.popPose();
    }
}
