...
public class CustomPlayerItemInHandLayer extends GeoLayerRenderer<CustomPlayerEntity> {
    ...
    public void renderItem(AnimatedGeoModel model, LivingEntity livingEntity, ItemStack itemStack, ItemDisplayContext itemDisplayContext, HumanoidArm humanoidArm, PoseStack poseStack, MultiBufferSource multiBufferSource, int i, float partialTick) {
        if (!itemStack.isEmpty()) {
            ...
            if (!applyItemBoneTransform(humanoidArm, poseStack, model)) {
                ...
                renderVanillaItemWithUseOrientation(livingEntity, itemStack, itemDisplayContext, humanoidArm, poseStack, multiBufferSource, i, partialTick);
            }
            poseStack.popPose();
    ...
    private void renderVanillaItemWithUseOrientation(LivingEntity livingEntity, ItemStack itemStack, ItemDisplayContext itemDisplayContext, HumanoidArm humanoidArm, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, float partialTick) {
        if (shouldNormalizeBowItemScale(itemStack)) {
            normalizeBowItemScale(poseStack);
        }
        renderVanillaItem(livingEntity, itemStack, itemDisplayContext, humanoidArm, poseStack, multiBufferSource, packedLight);
    }
    ...
    private void renderVanillaItem(LivingEntity livingEntity, ItemStack itemStack, ItemDisplayContext itemDisplayContext, HumanoidArm humanoidArm, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight) {
        this.itemRenderer.renderItem(livingEntity, itemStack, itemDisplayContext, humanoidArm == HumanoidArm.LEFT, poseStack, multiBufferSource, packedLight);
    }
