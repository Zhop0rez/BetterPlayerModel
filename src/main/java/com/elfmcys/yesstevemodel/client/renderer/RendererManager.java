...
public class RendererManager {
    ...
    private static void initRenderers(ResourceManager resourceManager) {
        ...
        EntityRendererProvider.Context context = new EntityRendererProvider.Context(
                ...
                accessor.ysm$getItemRenderer(), accessor.ysm$getBlockRenderDispatcher(), accessor.ysm$getItemInHandRenderer(), resourceManager, accessor.ysm$getEntityModels(), accessor.ysm$getFont()
        );
