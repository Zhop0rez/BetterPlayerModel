...
public class CategorySelectScreen extends Screen {
    ...
    public void init() {
        ...
        addRenderableWidget(new FlatColorButton(this.guiLeft + 20, this.guiTop + 178, 52, 18, Component.translatable("gui.better_player_model.pre_page"), button -> {
            if (this.page > 0) {
                this.page--;
                init();
            }
        }));
        addRenderableWidget(new FlatColorButton(this.guiLeft + 84, this.guiTop + 178, 52, 18, Component.translatable("gui.better_player_model.next_page"), button -> {
