...
public class DownloadScreen extends Screen {
    ...
    public void init() {
        ...
        addRenderableWidget(new FlatColorButton(left, topY, stationW, 18, stationLabel, b -> {
            com.elfmcys.yesstevemodel.client.ScreenFixer.setScreen(Minecraft.getInstance(), this.resourceStationScreen == null ? new ResourceStationScreen(this.parentScreen) : this.resourceStationScreen);
        }));
        ...
        addRenderableWidget(new FlatColorButton(right - returnW, topY, returnW, 18, returnLabel, b -> com.elfmcys.yesstevemodel.client.ScreenFixer.setScreen(Minecraft.getInstance(), this.parentScreen)));
