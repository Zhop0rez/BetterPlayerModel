...
public class EquippedEnchantmentLevel extends LivingEntityFunction {
    ...
    public Object eval(ExecutionContext<IContext<LivingEntity>> context, ArgumentCollection arguments) {
        ...
        for (int i = 1; i < arguments.size(); i++) {
            ...
            Enchantment raw = context.entity().entity().level().registryAccess().lookupOrThrow(Registries.ENCHANTMENT).get(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.ENCHANTMENT, id)).map(ref -> ref.value()).orElse(null);
            if (id != null && raw != null) {
