...
public class EffectLevel extends ContextFunction<Entity> {
    ...
    public Object eval(ExecutionContext<IContext<Entity>> context, ArgumentCollection arguments) {
        ...
        for (int i = 0; i < arguments.size(); i++) {
            ...
            if (effectId != null) {
                MobEffect mobEffect = BuiltInRegistries.MOB_EFFECT.getOptional(effectId).orElse(null);
                if (mobEffect != null) {
                    ...
                    if (context.entity().geoInstance() instanceof PlayerCapability cap
                        ...
                        if (!(((IContext<?>)context.entity()).entity() instanceof net.minecraft.world.entity.projectile.Arrow)) {
                            return null;
                        }
