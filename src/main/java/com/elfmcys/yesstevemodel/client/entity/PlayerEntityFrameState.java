...
public class PlayerEntityFrameState extends LivingEntityFrameState<Player> {
    ...
    private int lastMovementInputSyncTick;
    ...
    public void reset() {
        ...
        this.lastMovementInputSyncTick = 0;
    ...
    public void applySyncMessage(S2CSyncPlayerStatePacket message) {
        ...
        if ((message.flags & 128) != 0) {
            ...
            this.lastMovementInputSyncTick = this.entity.tickCount;
        }
    ...
    public int getTicksSinceMovementInputSync() {
        int ticks = this.entity.tickCount - this.lastMovementInputSyncTick;
