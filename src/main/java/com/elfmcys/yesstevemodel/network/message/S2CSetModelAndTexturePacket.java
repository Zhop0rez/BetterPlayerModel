...
public class S2CSetModelAndTexturePacket {
    ...
    public static S2CSetModelAndTexturePacket decode(FriendlyByteBuf friendlyByteBuf) {
        return new S2CSetModelAndTexturePacket(friendlyByteBuf.readVarInt(), friendlyByteBuf.readUtf(MAX_MODEL_ID_LENGTH), friendlyByteBuf.readUtf(MAX_TEXTURE_ID_LENGTH), friendlyByteBuf.readBoolean(), S2CSyncPlayerStatePacket.decode(friendlyByteBuf));
    }
