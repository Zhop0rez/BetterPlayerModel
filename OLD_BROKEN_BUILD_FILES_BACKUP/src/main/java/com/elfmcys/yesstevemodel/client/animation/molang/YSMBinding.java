...
import com.elfmcys.yesstevemodel.mixin.client.ThrowableProjectileAccessor;
...
public class YSMBinding extends ContextBinding {
    ...
    private static String getThrowableItemId(IContext<ThrowableProjectile> context) {
        ThrowableProjectile ThrowableProjectile = context.entity();
        if (ThrowableProjectile instanceof ThrowableProjectileAccessor accessor) {
