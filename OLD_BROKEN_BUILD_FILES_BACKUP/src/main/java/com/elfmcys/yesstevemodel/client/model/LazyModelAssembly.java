        ...
        try {
            ...
            if (isLocal) {
                if (isLocalDirectory) {
                    ...
                    rawModel = ModelManager.parseImportModel(cachedFile.getName(), fileBytes);
                }
            } else {
                byte[] fileBytes = Files.readAllBytes(cachedFile.toPath());
            ...
            ModelManager.touchModel(modelId);
            ...
            ModelAssembly defaultModel = ModelManager.getModelAssemblyMap().get("default");
