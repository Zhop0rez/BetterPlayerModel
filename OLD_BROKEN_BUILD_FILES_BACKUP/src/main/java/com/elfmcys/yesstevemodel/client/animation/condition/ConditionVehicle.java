...
public class ConditionVehicle {
    ...
    private static final ResourceLocation LEGACY_BOAT_ID = ResourceLocation.fromNamespaceAndPath("minecraft", "boat");

    private static final ResourceLocation LEGACY_CHEST_BOAT_ID = ResourceLocation.fromNamespaceAndPath("minecraft", "chest_boat");
