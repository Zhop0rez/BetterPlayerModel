...
public final class MolangLexerImpl implements MolangLexer {
    ...
    private @NotNull Token next0() throws IOException {
        ...
        boolean isLastIdentifier = (lastToken != null && lastToken.kind() == TokenKind.ResourceLocation);
        if (Characters.isDigit(c) || (!isLastIdentifier && c == '.')) {
            ...
            // may be an ResourceLocation or a keyword
            ...
            switch (word) {
                ...
                default: kind = TokenKind.ResourceLocation; break;
                //@formatter:on
            }
            ...
            return new Token(
                    ...
                    kind == TokenKind.ResourceLocation ? word : null,
                    start,
                    cursor.index()
            );
