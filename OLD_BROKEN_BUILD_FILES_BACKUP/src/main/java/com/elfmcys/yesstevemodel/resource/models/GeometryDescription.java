...
public class GeometryDescription {
    ...
    //"ResourceLocation": "geometry.unknown",
    //"texture_width": 128,
    //"texture_height": 128,
    //"visible_bounds_width": 7,
    //"visible_bounds_height": 9,
    //"visible_bounds_offset": [0, 1.5, 0]
    public GeometryDescription(String ResourceLocation, double textureWidth, double textureHeight, double visibleBoundsWidth, double visibleBoundsHeight, double[] visibleBoundsOffset) {
